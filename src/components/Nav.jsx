...
const Nav = () => {
  return (
    <div className='bg-[#f7f0f0] h-[10vh] flex items-center justify-center'>
        ...
        <Link className='p-5 font-bold text-xl text-blue-900' to='/registrationform'>Register as Helper</Link>
        <Link className='p-5 font-bold text-xl text-pink-800' to='/donate'>Donate</Link>
    </div>
  )
}
